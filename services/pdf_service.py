...
def generate_monthly_report(user: dict, receipts: List[dict], year: int, month: int) -> bytes:
    ...
    doc = SimpleDocTemplate(
        ...
        topMargin=1.5 * cm,
        bottomMargin=1.5 * cm,
        title=f"AlgoSphere – Expense Report {year}-{month:02d}",
    )
    ...
    story.append(Paragraph("AlgoSphere", title_style))
    ...
    story.append(Paragraph("Generated by AlgoSphere – Intelligent Expense Manager", footer_style))
